...
__global__ void cal_Indepl0(double *C, int *G, int* Sepset, double *pMax, int* tiers, double alpha, int n, int nrows, int M);
__global__ void cal_Indepl1(double *C, int *G, int *GPrime, int *mutex, int* Sepset, double* pMax, int* tiers, double alpha, int n, int nrows, int M);
__global__ void cal_Indepl2(double *C, int *G, int* GPrime, int *mutex, int* Sepset, double* pMax, int* tiers, double alpha, int n, int nrows, int M);
__global__ void cal_Indepl3(double *C, int *G, int* GPrime, int *mutex, int* Sepset, double* pMax, int* tiers, double alpha, int n, int nrows, int M);
__global__ void cal_Indepl4(double *C, int *G, int* GPrime, int *mutex, int* Sepset, double* pMax, int* tiers, double alpha, int n, int nrows, int M);
__global__ void cal_Indepl5(double *C, int *G, int* GPrime, int *mutex, int* Sepset, double* pMax, int* tiers, double alpha, int n, int nrows, int M);
__global__ void cal_Indepl6(double *C, int *G, int* GPrime, int *mutex, int* Sepset, double* pMax, int* tiers, double alpha, int n, int nrows, int M);
__global__ void cal_Indepl7(double *C, int *G, int* GPrime, int *mutex, int* Sepset, double* pMax, int* tiers, double alpha, int n, int nrows, int M);
__global__ void cal_Indepl8(double *C, int *G, int* GPrime, int *mutex, int* Sepset, double* pMax, int* tiers, double alpha, int n, int nrows, int M);
__global__ void cal_Indepl9(double *C, int *G, int* GPrime, int *mutex, int* Sepset, double* pMax, int* tiers, double alpha, int n, int nrows, int M);
__global__ void cal_Indepl10(double *C, int *G, int* GPrime, int *mutex, int* Sepset, double* pMax, int* tiers, double alpha, int n, int nrows, int M);
__global__ void cal_Indepl11(double *C, int *G, int* GPrime, int *mutex, int* Sepset, double* pMax, int* tiers, double alpha, int n, int nrows, int M);
__global__ void cal_Indepl12(double *C, int *G, int* GPrime, int *mutex, int* Sepset, double* pMax, int* tiers, double alpha, int n, int nrows, int M);
__global__ void cal_Indepl13(double *C, int *G, int* GPrime, int *mutex, int* Sepset, double* pMax, int* tiers, double alpha, int n, int nrows, int M);
__global__ void cal_Indepl14(double *C, int *G, int* GPrime, int *mutex, int* Sepset, double* pMax, int* tiers, double alpha, int n, int nrows, int M);
__global__ void cal_Indep(double *C, int *G, int* GPrime, int *mutex, int* Sepset, double* pMax, int* tiers, double alpha, int n, int nrows, int M, int order);
...
extern "C" void SkeletonMI(double* C, int *P, int *Nrows, int *m, int *G, double *Alpha, int *l, int *maxlevel, double *pMax, int* SepSet, int* tiers, int* DF_method);
